    ...
    protected void treat(final SOCMessage mes, final boolean didDebugPrintAlready)
    {
        ...
        try
        {
            ...
            case SOCMessage.BOARDLAYOUT:
                handleBOARDLAYOUT((SOCBoardLayout) mes, games.get(((SOCBoardLayout) mes)));
                break;
            ...
            case SOCMessage.BOARDLAYOUT2:
                handleBOARDLAYOUT2((SOCBoardLayout2) mes, games.get(((SOCBoardLayout2) mes)));
                break;
            ...
            case SOCMessage.POTENTIALSETTLEMENTS:
                handlePOTENTIALSETTLEMENTS((SOCPotentialSettlements) mes, games.get((SOCPotentialSettlements) mes));
                break;
